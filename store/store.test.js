...
import reducer,{splitSneakerInfo} from "./releaseInfo";
...
describe("redux state tests", () => {
  ...
  it("split shoes to future and past", async () => {


    expect(reducer(mockData, splitSneakerInfo(state))).toEqual([
