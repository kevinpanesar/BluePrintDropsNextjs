...
export const fetchSneakerInfo = createAsyncThunk('sneaker/fetchSneaker', async () => {
...
const sneakerSlice = createSlice({
    ...
    reducers: {
        ...
        searchFeed: (state, action) => {
            state.futureSneakerInfo.filter((element) => element.title.toLowerCase().includes(action.payload.toLowerCase()))
        },
        ...
        selectMensWomensKids: (state, action) => {
            ...
            if(action.payload === 'reset'){
                ...
                state.futureSneakerInfoAgeOrGender = state.futureSneakerInfo.filter((element) => element[action.payload] === true);
                state.pastSneakerInfoAgeOrGender = state.pastSneakerInfo.filter((element) => element[action.payload] === true);
            }
